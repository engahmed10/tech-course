...
hash.each do |i|
    ...
    @course=Course.create(name: i["course_name"],course_description: i["coursedescription"],duration: i["duration"],cost_total: i["cost_total"],institute: institute,education: education,user: user)
    user.courses << @course
    user.save
